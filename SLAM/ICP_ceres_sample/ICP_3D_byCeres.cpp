...
//    }
    ...
    //-- 读取图像
    string loadPath = "/home/ztj/PRJ3_map/wheels_cpp/SLAM/ICP/";
    Mat img_1 = imread(loadPath+"1.png", CV_LOAD_IMAGE_COLOR);
    Mat img_2 = imread(loadPath+"2.png", CV_LOAD_IMAGE_COLOR);
    ...
    // 建立3D点
    Mat depth1 = imread(loadPath+"1_depth.png", CV_LOAD_IMAGE_UNCHANGED);       // 深度图为16位无符号数，单通道图像
    Mat depth2 = imread(loadPath+"2_depth.png", CV_LOAD_IMAGE_UNCHANGED);       // 深度图为16位无符号数，单通道图像
                            ...
                            std::vector< DMatch >& matches )
{
    ...
    // used in OpenCV3
    Ptr<FeatureDetector> detector = ORB::create();//no bugs here
